...
type
  TDMZadM = class(TDataModule)
    ...
    DSQuranCDS: TDataSource;
    DSSoraCDS: TDataSource;
    DSQuranHarfCDS: TDataSource;
    QuranCDS: TClientDataSet;
    SoraCDS: TClientDataSet;
    SoraCDSSORANO: TAutoIncField;
    SoraCDSNAME: TWideStringField;
    SoraCDSPageMushaf: TIntegerField;
    SoraCDSLieuNouzoul: TWideStringField;
    SoraCDSOrdreNouzoul: TIntegerField;
    SoraCDSOrdreMushaf: TIntegerField;
    SoraCDSAiaCount: TIntegerField;
    SoraCDSKalimaCount: TIntegerField;
    SoraCDSHarfCount: TIntegerField;
    QuranHarfCDS: TClientDataSet;
    DSPQuran: TDataSetProvider;
    DSPSora: TDataSetProvider;
    DSPQuranHarf: TDataSetProvider;
    DSQuranHtzCDS: TDataSource;
    QuranHtzCDS: TClientDataSet;
    DSPHtz: TDataSetProvider;
    ...
    QuranCDSLINENO: TAutoIncField;
    QuranCDSLINEAIA: TIntegerField;
    QuranCDSSORANO: TIntegerField;
    QuranCDSAIANO: TIntegerField;
    QuranCDSAIAMADINA: TWideMemoField;
    QuranCDSAIATANZIL: TWideMemoField;
    QuranCDSNBHARF: TIntegerField;
    QuranCDSNBKALIMA: TIntegerField;
    QuranCDSNBHARFTZ: TIntegerField;
    QuranCDSNBKALIMATZ: TIntegerField;
    ...
    DSPqmotTZ: TDataSetProvider;
    DSdicmotTZCDS: TDataSource;
    dicmotTZCDS: TClientDataSet;
    DSPdicmotTZCDS: TDataSetProvider;
    ...
    DSQuranQCDS: TDataSource;
    QuranQCDS: TClientDataSet;
    ...
    DSPQuranQ: TDataSetProvider;
    DSSoraHarfCDS: TDataSource;
    SoraHarfCDS: TClientDataSet;
    DSPSoraHarf: TDataSetProvider;
    ...
    FDSoraNameVal_H10: TIntegerField;
    FDSoraNameVal_H14: TIntegerField;
    FDSoraNameVal_H21: TIntegerField;
    FDSoraNameVal_H28: TIntegerField;
    FDQuerySoraVal_H10: TIntegerField;
    FDQuerySoraVal_H14: TIntegerField;
    FDQuerySoraVal_H21: TIntegerField;
    FDQuerySoraVal_H28: TIntegerField;
    SoraCDSVal_H10: TIntegerField;
    SoraCDSVal_H14: TIntegerField;
    SoraCDSVal_H21: TIntegerField;
    SoraCDSVal_H28: TIntegerField;
    FDTable1: TFDTable;
    DataSource1: TDataSource;
    FDQeditCoran: TFDQuery;
    FDDSQeditCoran: TDataSource;
